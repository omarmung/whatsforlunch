...
<<<<<<< HEAD
	...
	post.description = post.description.replace(/<h3>/g,"<h3 class='titles hide'>");
	...
	// post.description = post.description.replace(/<p>/g,"<p class='hide'>"); // paragraph hiding on/off
	...
	post.description = post.description.replace(localStorage["favorite_color"],"<span class='favorite'>" + localStorage["favorite_color"] + "</span>");
...
=======
  ...
  post.description = post.description.replace(/<h3 class=\'hide\'>hack week snack/, "<h3 class='show'>hack week snack");
  post.description = post.description.replace(/<h3 class=\'hide\'>happy hour/, "<h3 class='show'>happy hour =|;{>");
>>>>>>> 25a5a5124f91f9524cee04106a4e22032d33316c
